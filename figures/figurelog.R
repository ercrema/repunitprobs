...
legend("topright", lwd=c(3,1), col=c("plum1","grey25"), legend=c("Early mines (c1700 BC)","mean (EarlyMiddle/Late)"), bty="n", cex=0.7)
...
lines(pooled[,1],pooled[,2], col="grey25", lwd=2)
legend("topright", lwd=c(3,1), col=c("cadetblue","grey25"), legend=c("Middle mines (c1300 BC)","mean (EarlyMiddle/Late)"), bty="n", cex=0.7)
...
lines(pooled[,1],pooled[,2], col="grey25", lwd=2)
legend("topright", lwd=c(3,1), col=c("palegreen","grey25"), legend=c("Late mines (c900 BC)","mean (EarlyMiddle/Late)"), bty="n", cex=0.7)
